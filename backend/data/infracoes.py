# Dicionário de infrações e seus tipos
...
infrações = {
    ...
    "Estacionar em local de carga e descarga": "parado",
    "Estacionar em rampa de acessibilidade": "parado",
    "Estacionar em esquina": "parado",
}